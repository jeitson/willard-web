...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        '../process/certificate-information/certificate-information.module'
      ).then(
  ...
  },
  {
    path: 'file-upload',
    loadChildren: () =>
      import('../process/load/file-upload/file-upload.module').then(
  ...
  },
  {
    path: 'file-report',
    loadChildren: () =>
      import('../process/load/report-file/report-file.module').then(
